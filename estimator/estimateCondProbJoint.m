function condProb = estimateCondProbJoint(y, cond, joint, nVars)
%condProb = estimateCondProbJoint(y, cond, joint, nVars)
% estimate probability y|x from joint probability distribution
nY = length(y);
...
p_cond = sumOverDims(joint, nCond+1:nVars)+eps;% setdiff(1:nVars, [x z]) % put y last so you can divide
