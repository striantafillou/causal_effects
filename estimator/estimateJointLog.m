function [joint, vals]= estimateJointLog(nodes, domainCounts)
% [joint, vals]= estimateJointLog(nodes, domainCounts);
% estimates log joint probability distribution (bruteforce) for exact
% inference.
nVars = length(nodes);
% estimate joint
